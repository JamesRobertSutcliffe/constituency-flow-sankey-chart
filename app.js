...
async function init() {
    try {
        ...
        const seats = {
            "Conservatives2019": cons2019.length,
        ...
        const sankey = d3.sankey()
            .nodeWidth(30)
            .nodePadding(20)
            .extent([[10, 50], [width - 10, height - 50]]);
        ...
        svg.append("text")
            ...
            .text(`Total seat outflows from Conservatives: ${totalOutflowsPercentage}%`);
